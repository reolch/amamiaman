...
export const metadata: Metadata = {
  ...
  description: '奄美大島の美しい自然を大切にし、お客様に最高のマリン体験をお届けしたいというヤマハタマリンサービスの想いをご紹介します。あまみあまん・マリンサービスあまんとしても知られています。',
  keywords: '奄美大島, 想い, こだわり, ヤマハタマリンサービス, あまみあまん, マリンサービスあまん, マリンアクティビティ, 自然保護',
  openGraph: {
    title: '私たちの想い | ヤマハタマリンサービス - 奄美大島',
